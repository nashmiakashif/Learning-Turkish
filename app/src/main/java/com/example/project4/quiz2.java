...
public class quiz2 extends AppCompatActivity {
    ...
    {
        if(t3.getText().toString().equalsIgnoreCase("erkek kardeş"))
        {
            MediaPlayer media = MediaPlayer.create(quiz2.this,R.raw.right);
            media.start();
        ...
        {
            MediaPlayer media = MediaPlayer.create(quiz2.this,R.raw.wrong);
            media.start();
    ...
    protected void onStart() {
        super.onStart();
        MediaPlayer media = MediaPlayer.create(quiz2.this,R.raw.erkek);
        media.start();
