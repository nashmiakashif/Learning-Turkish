...
public class quiz1 extends AppCompatActivity {
    ...
    {
        if(t3.getText().toString().equalsIgnoreCase("Merhaba"))
        {
            MediaPlayer media = MediaPlayer.create(quiz1.this,R.raw.right);
            media.start();
        ...
        {
            MediaPlayer media = MediaPlayer.create(quiz1.this,R.raw.wrong);
            media.start();
    ...
    protected void onStart() {
        super.onStart();
        MediaPlayer media = MediaPlayer.create(quiz1.this,R.raw.merhaba);
        media.start();
