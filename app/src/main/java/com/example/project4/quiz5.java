...
public class quiz5 extends AppCompatActivity {
    ...
    {
        if(t3.getText().toString().equalsIgnoreCase("Aşkım"))
        {
            MediaPlayer media = MediaPlayer.create(quiz5.this,R.raw.right);
            media.start();
        ...
        {
            MediaPlayer media = MediaPlayer.create(quiz5.this,R.raw.wrong);
            media.start();
    ...
    protected void onStart() {
        super.onStart();
        MediaPlayer media = MediaPlayer.create(quiz5.this,R.raw.askim);
        media.start();
