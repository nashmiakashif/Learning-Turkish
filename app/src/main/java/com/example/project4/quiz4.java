...
public class quiz4 extends AppCompatActivity {
    ...
    {
        if(t3.getText().toString().equalsIgnoreCase("Lütfen"))
        {
            MediaPlayer media = MediaPlayer.create(quiz4.this,R.raw.right);
            media.start();
        ...
        {
            MediaPlayer media = MediaPlayer.create(quiz4.this,R.raw.wrong);
            media.start();
    ...
    protected void onStart() {
        super.onStart();
        MediaPlayer media = MediaPlayer.create(quiz4.this,R.raw.luten);
        media.start();
