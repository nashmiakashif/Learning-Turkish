...
public class quiz8 extends AppCompatActivity {
    ...
    {
        if(t3.getText().toString().equalsIgnoreCase("Çocuk"))
        {
            MediaPlayer media = MediaPlayer.create(quiz8.this,R.raw.wrong);
            media.start();
    ...
    {
        Intent intent = new Intent(quiz8.this, path.class);
        startActivity(intent);
    }
    @Override
    protected void onStart() {
        super.onStart();
        MediaPlayer media = MediaPlayer.create(quiz8.this,R.raw.cocuk);
        media.start();
