...
public class quiz6 extends AppCompatActivity {
    ...
    {
        if(t3.getText().toString().equalsIgnoreCase("Hoşgeldiniz"))
        {
            MediaPlayer media = MediaPlayer.create(quiz6.this,R.raw.right);
            media.start();
        ...
        {
            MediaPlayer media = MediaPlayer.create(quiz6.this,R.raw.wrong);
            media.start();
    ...
    protected void onStart() {
        super.onStart();
        MediaPlayer media = MediaPlayer.create(quiz6.this,R.raw.hosh);
        media.start();
