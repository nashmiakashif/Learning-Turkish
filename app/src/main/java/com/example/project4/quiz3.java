...
public class quiz3 extends AppCompatActivity {
    ...
    {
        if(t3.getText().toString().equalsIgnoreCase("Teşekkürler"))
        {
            MediaPlayer media = MediaPlayer.create(quiz3.this,R.raw.right);
            media.start();
        ...
        {
            MediaPlayer media = MediaPlayer.create(quiz3.this,R.raw.wrong);
            media.start();
    ...
    protected void onStart() {
        super.onStart();
        MediaPlayer media = MediaPlayer.create(quiz3.this,R.raw.tash);
        media.start();
